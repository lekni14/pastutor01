                    ...
                    <tbody>                        
                        ...
                        <tr>
                            <td style="font-family:Arial,Helvetica,sans-serif;font-size:13px;padding:10px;text-indent:1cm;text-align:justify">
                                <p>เรียน <?php echo $admin['first_name'].'  '.$admin['last_name'];?></p>
                            </td>
                        </tr>
                        <tr>
                            <td style="font-family:Arial,Helvetica,sans-serif;font-size:13px;padding:10px;text-indent:1cm;text-align:justify">
                                <p style="margin: 0px">username คือ <?=$admin['username']?></p>
                                <p style="margin: 0px">password คือ<?=$admin['password']?></p>                                
                            </td>
                        </tr>
                        <tr>
                            <td style="font-family:Arial,Helvetica,sans-serif;font-size:13px;padding:10px;text-indent:1cm;text-align:justify">
                                <p style="margin: 0px">หากท่านมีข้อสงสัยประการใดหรือต้องการสอบถามข้อมูลเพิ่มเติม กรุณาติดต่อ</p>
                                <p style="margin: 0px">โทรศัพท์ : 091-8656125 </p>
                            </td>
                        </tr>
                    </tbody>
                </table>
