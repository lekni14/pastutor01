...
$pdf->SetXY(34, 52);
//$pdf->MultiCell(0, '', iconv('UTF-8', 'TIS-620//TRANSLIT', $first_name), 0 , 'L' , false);

//--- $last_name 
$pdf->SetFont('angsana', '', 16);
$pdf->SetXY(115, 52);
$pdf->MultiCell(0, '',iconv('UTF-8', 'TIS-620', $last_name)  , 0 , 'L' , false);
...
//$pdf->SetXY(153, 96);
//$pdf->SetFont('angsana', '', 16);
//$pdf->MultiCell(0, '',iconv('UTF-8', 'TIS-620', $balance)  , 0 , 'L' , false);

////--- $countperson 
//$pdf->SetFont('angsana', '', 16);
//$pdf->SetXY(68, 96);
//$pdf->MultiCell(0, '',iconv('UTF-8', 'TIS-620', $countperson)  , 0 , 'L' , false);

//--- $countperson 
$pdf->SetFont('angsana', '', 16);
$pdf->SetXY(49, 69);
$pdf->MultiCell(0, '',iconv('UTF-8', 'TIS-620', $course)  , 0 , 'L' , false);
...
$pdf->SetFont('angsana', '', 16);
$pdf->SetXY(36, 86);
$pdf->MultiCell(0, '',iconv('UTF-8', 'TIS-620', $location)  , 0 , 'L' , false);
...
foreach ($application['applicants'] as $key => $value) {
    ...
    $pdf->SetFont('angsana', '', 16);
    $pdf->SetXY(30, $row);
    $pdf->MultiCell(0, '',iconv('UTF-8', 'TIS-620', $value['first_name'])  , 0 , 'L' , false);
    
    $pdf->SetFont('angsana', '', 16);
    $pdf->SetXY(95, $row);
    $pdf->MultiCell(0, '',iconv('UTF-8', 'TIS-620', $value['last_name'])  , 0 , 'L' , false);
    
    $pdf->SetFont('angsana', '', 16);
    $pdf->SetXY(160, $row);
    $pdf->MultiCell(0, '',iconv('UTF-8', 'TIS-620', ($value['contact_no'])?$value['contact_no']:'-')  , 0 , 'L' , false);
    $row = $row+5;
}
